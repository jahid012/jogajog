            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="text-center">
                        <img alt="image" class="img-fluid rounded-circle" src="{{asset('assets/images/thumb-4.jpg')}}" width="90" height="90">
                    ...
                    <div>
                        <div class="detail-list mb-4 text-center">
                            ...
                            <h4 class="m-0 text-small">$459</h4>
                        </div>
    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="text-center">
                        <img alt="image" class="img-fluid rounded-circle" src="{{asset('assets/images/thumb-1.jpg')}}" width="90" height="90">
                        <h6 class="mt-2 font-weight-bold">Ethan Moore</h6>
                    </div>
                    <div class="flex-grow-1 px-5">
                        <h4 class="mb-3">Soylent Vency Cafe <span class="badge badge-pill badge-danger text-uppercase">Pending</span></h4>
